...
from src.rag_service.lightrag.types import GPTKeywordExtractionFormat
from src.rag_service.lightrag.api import __api_version__
from src.rag_service.lightrag.utils import EmbeddingFunc
from src.rag_service.lightrag.utils import logger
...
def create_app(args):
    ...
    from src.rag_service.lightrag.utils import set_verbose_debug
    ...
    if args.llm_binding == "lollms" or args.embedding_binding == "lollms":
        from src.rag_service.lightrag.llm.lollms import (
            lollms_model_complete,
            lollms_embed,
        )
    if args.llm_binding == "ollama" or args.embedding_binding == "ollama":
        from src.rag_service.lightrag.llm.ollama import (
            ollama_model_complete,
            ollama_embed,
        )
    if args.llm_binding == "openai" or args.embedding_binding == "openai":
        from src.rag_service.lightrag.llm.openai import (
            openai_complete_if_cache,
            openai_embed,
        )
    if args.llm_binding == "azure_openai" or args.embedding_binding == "azure_openai":
        from src.rag_service.lightrag.llm.azure_openai import (
            azure_openai_complete_if_cache,
            azure_openai_embed,
        )
    if args.llm_binding_host == "openai-ollama" or args.embedding_binding == "ollama":
        from src.rag_service.lightrag.llm.openai import openai_complete_if_cache
        from src.rag_service.lightrag.llm.ollama import ollama_embed
